...
export default async function AboutPage() {
  return (
    <div>
      ...
      <h2 className="mt-10 scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight transition-colors first:mt-0 font-heading">
        The King's Plan
      </h2>
      <p className="leading-7 [&:not(:first-child)]:mt-6">
      ...
      <h3 className="mt-8 scroll-m-20 text-2xl font-semibold tracking-tight font-heading">
        The Joke Tax
      </h3>
      <p className="leading-7 [&:not(:first-child)]:mt-6">
